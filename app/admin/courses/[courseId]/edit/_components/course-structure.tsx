...
export const CourseStructure = ({ data }: CourseStructureProps) => {
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    if (activeType === "chapter") {
      ...
      if (!targetChapterId) {
        toast.error("No se pudo determinar el capítulo para reordenar");
        return;
      }
      ...
      if (oldIndex === -1 || newIndex === -1) {
        toast.error(
          "No se pudo encontrar el índice antiguo/nuevo del capítulo para reordenar",
        );
        return;
      }
      ...
      if (courseId) {
        ...
        toast.promise(reorderPromise, {
          ...
          error: () => {
            ...
            return "No se pudieron reordenar los capítulos";
          },
        });
      }
    ...
    if (activeType === "lesson" && overType === "lesson") {
      ...
      if (!chapterId || chapterId !== overChapterId) {
        toast.error(
          "No se permite mover la lección entre diferentes capítulos o no se permite un ID de capítulo no válido",
        );
        return;
      }
      ...
      if (chapterIndex === -1) {
        toast.error("No se pudo encontrar el capítulo de la lección");
        return;
      }
      ...
      if (oldLessonIndex === -1 || newLessonIndex === -1) {
        toast.error("No se pudo encontrar la lección para reordenar");
        return;
      }
